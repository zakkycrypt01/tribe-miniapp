 ...
 */
export const APP_NAME: string = 'tribe';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'app';
 ...
 */
export const APP_TAGS: string[] = ['defi'];
 ...
 */
export const APP_ICON_URL: string = `${APP_URL}/TRIBE.jpg`;
 ...
 */
export const APP_SPLASH_URL: string = `${APP_URL}/TRIBE.jpg`;
